    ...
    <div class="flex flex-wrap">
      ...
      <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30"
        ...
        <div class="w-full h-20 border-b flex px-4 items-center mb-8">
          <p class="font-semibold text-3xl text-blue-400 pl-4">MD-Terfa EventSpan</p>
        </div>
        ...
        <div class="mb-4 px-4">
          <p class="pl-4 text-black font-semibold mb-1">Projects</p>

          <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer" v-for="project in user.team.projects" :key="project.id">
            <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
              <path
      ...
      <div class="w-full border-t-2 bg-gray-100 text-black px-8 py-6 lg:flex justify-between items-center">
        <p class="mb-2 lg:mb-0 text-black">© Copyright 2020</p>
